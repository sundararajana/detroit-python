...
This branch requires Python 3.12.
...
You can create install Python 3.12, create a virtual environment and
activate it using the following commands:

```sh
pyenv install 3.12
pyenv virtualenv 3.12 mypyenv-3.12
pyenv activate mypyenv-3.12
```
