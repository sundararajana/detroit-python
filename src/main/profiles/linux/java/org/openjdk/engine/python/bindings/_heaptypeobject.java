...
public class _heaptypeobject {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Python_h.C_POINTER.withName("ht_token"),
    ...
    private static final AddressLayout ht_token$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("ht_token"));
     ...
     * }
     */
    public static final AddressLayout ht_token$layout() {
        return ht_token$LAYOUT;
    }

    private static final long ht_token$OFFSET = $LAYOUT.byteOffset(groupElement("ht_token"));
     ...
     * }
     */
    public static final long ht_token$offset() {
        return ht_token$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment ht_token(MemorySegment struct) {
        return struct.get(ht_token$LAYOUT, ht_token$OFFSET);
    }
     ...
     * }
     */
    public static void ht_token(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(ht_token$LAYOUT, ht_token$OFFSET, fieldValue);
    }
