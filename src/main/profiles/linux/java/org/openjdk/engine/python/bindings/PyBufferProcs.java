...
public class PyBufferProcs {
    ...
    private static final long bf_getbuffer$OFFSET = $LAYOUT.byteOffset(groupElement("bf_getbuffer"));
    ...
    private static final long bf_releasebuffer$OFFSET = $LAYOUT.byteOffset(groupElement("bf_releasebuffer"));
