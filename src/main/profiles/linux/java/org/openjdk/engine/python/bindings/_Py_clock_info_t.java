...
public class _Py_clock_info_t {
    ...
    private static final long implementation$OFFSET = $LAYOUT.byteOffset(groupElement("implementation"));
    ...
    private static final long monotonic$OFFSET = $LAYOUT.byteOffset(groupElement("monotonic"));
    ...
    private static final long adjustable$OFFSET = $LAYOUT.byteOffset(groupElement("adjustable"));
    ...
    private static final long resolution$OFFSET = $LAYOUT.byteOffset(groupElement("resolution"));
