...
public class PyCompilerFlags {
    ...
    private static final long cf_flags$OFFSET = $LAYOUT.byteOffset(groupElement("cf_flags"));
    ...
    private static final long cf_feature_version$OFFSET = $LAYOUT.byteOffset(groupElement("cf_feature_version"));
