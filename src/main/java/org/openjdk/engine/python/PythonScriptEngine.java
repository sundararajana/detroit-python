...
public final class PythonScriptEngine extends AbstractPythonScriptEngine {
    ...
    private final class EngineLifeCycleManager {
        ...
        private static PythonScriptEngine newMainEngineInternal(PythonScriptEngineFactory fac) {
            ...
            NONE = Py_GetConstant(Py_CONSTANT_NONE());
            FALSE = Py_GetConstant(Py_CONSTANT_FALSE());
            TRUE = Py_GetConstant(Py_CONSTANT_TRUE());
            ELLIPSIS = Py_GetConstant(Py_CONSTANT_ELLIPSIS());
            NOT_IMPLEMENTED = Py_GetConstant(Py_CONSTANT_NOT_IMPLEMENTED());
