...
public class BindingsTest {
    ...
    @Test
    public void getGlobalVarTest() throws ScriptException {
    ...
    @Test
    public void setGlobalVarTest() throws ScriptException {
        engine.withPyObjectManager(() -> {
            engine.put("hello", "world");
            engine.setExecMode(PyExecMode.EVAL);
            assertEquals(engine.get("hello").toString(), "world");
            engine.setExecMode(PyExecMode.SINGLE);
            engine.eval("hello = True");
            assertEquals(engine.get("hello"), engine.getTrue());
            return null;
        });
    }
}