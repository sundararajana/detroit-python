...
public class SysPathPrependTest extends AbstractSysPathTest {
    ...
    @Test
    public void testSysPathPrepend() throws IOException, ScriptException {
        // check the sys.path first entry
