...
public class ManyEnginesManyThreadsTest {

    private static final int NUM_ENGINES = 25;

    @Test
    public void testManyEnginesInManyThreads() throws ScriptException, InterruptedException {
